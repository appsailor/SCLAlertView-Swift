...
open class SCLAlertView: UIViewController {
    ...
    func keyboardWillShow(_ notification: Notification) {
        ...
        if let userInfo = (notification as NSNotification).userInfo {
            let beginKeyBoardFrame = userInfo[UIKeyboardFrameBeginUserInfoKey] as! NSValue
            let endKeyBoardFrame = userInfo[UIKeyboardFrameEndUserInfoKey] as! NSValue
...
//                if let endKeyBoardFrame = (userInfo[UIKeyboardFrameEndUserInfoKey] as AnyObject).cgRectValue.origin.y {
                    ...
                    let newContentViewFrameY = beginKeyBoardFrame.cgRectValue.origin.y - endKeyBoardFrame.cgRectValue.origin.y - self.contentView.frame.origin.y
